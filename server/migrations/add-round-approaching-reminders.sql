...
ALTER TABLE survey_rounds ADD COLUMN IF NOT EXISTS admin_reminder_7_sent BOOLEAN DEFAULT FALSE;
ALTER TABLE survey_rounds ADD COLUMN IF NOT EXISTS admin_reminder_1_sent BOOLEAN DEFAULT FALSE;
