        ...
        {!result ? (
          <>
            ...
            <p className="text-gray-600 mb-4">
              You're about to send survey invitations to {selectedUserObjects.length} board member
                      ...
                      <table className="min-w-full">
                        ...
                        <tbody className="divide-y divide-gray-200">
                          {result.results.map((r, idx) => (
                            <tr
                              key={idx}
                              className={r.status === "sent" ? "bg-green-50" : "bg-red-50"}
                            >
                              <td className="px-4 py-2 text-sm">
                              ...
                              <td className="px-4 py-2 text-sm text-gray-600">{r.error || "—"}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
