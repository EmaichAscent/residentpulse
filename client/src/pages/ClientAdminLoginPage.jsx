      ...
      <div className="relative min-h-screen flex flex-col lg:flex-row items-center justify-center px-4 py-8 gap-8 lg:gap-16 max-w-6xl mx-auto">
        ...
        <div className="flex-1 max-w-lg text-center lg:text-left">
          ...
          <a
            ...
            className="inline-flex items-center justify-center lg:justify-start gap-2 mb-6 text-white/70 hover:text-white/90 transition-colors"
          >
          ...
          <p className="hidden lg:block text-white/80 text-lg mb-8">
            ResidentPulse gives HOA management companies direct insight into board member
            satisfaction — so you can improve service, prevent surprises at renewal time, and prove
            your value with data.
          </p>
          <p className="lg:hidden text-white/80 text-base mb-4">
            Direct insight into board member satisfaction — improve service, prevent surprises, and
          ...
          <div className="mb-6 lg:hidden">
            ...
            <p className="text-white/50 text-xs mt-2 text-center">
              No credit card required. Free for up to 25 board members.
            </p>
          </div>
          ...
          <div className="space-y-3 lg:space-y-4 mb-6 lg:mb-8">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-white font-semibold text-sm lg:text-base">
                  Survey Board Members Directly
                </p>
                <p className="text-white/60 text-sm hidden lg:block">
                  Automated NPS rounds on your schedule — we invite, remind, and collect responses
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm hidden lg:block">
                  Our AI analyzes open-ended feedback and surfaces what boards actually care about —
                  so you can act before issues escalate.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-white font-semibold text-sm lg:text-base">
                  Retain More Communities
                </p>
                <p className="text-white/60 text-sm hidden lg:block">
                  Spot dissatisfaction early, demonstrate responsiveness, and turn renewals into a
                  formality.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-white font-semibold text-sm lg:text-base">
                  Build Your Reputation With Data
                </p>
                <p className="text-white/60 text-sm hidden lg:block">
                  Share NPS scores with prospective clients to stand out from competitors who are
                  just guessing.
                </p>
              </div>
            </div>
