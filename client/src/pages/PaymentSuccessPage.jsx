          ...
          <div className="bg-white shadow-2xl rounded-2xl p-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Your subscription is being activated. Check your email for a verification link to
                complete your account setup.
              </p>
              <p className="text-sm text-gray-500 mb-6">
                The verification email will arrive within a few minutes. If you don't see it, check
                your spam folder.
              </p>
              <Link
                to="/admin/login"
